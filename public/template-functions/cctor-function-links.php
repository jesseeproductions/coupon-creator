...
function cctor_show_link($coupon_id) {
	...
	if (cctor_options('cctor_hide_print_link') == 0) {
		...
		?><div class='cctor_opencoupon'><a class="print-link"<?php echo $nofollow; ?> href='<?php echo esc_url( get_permalink( $coupon_id ) ); ?>' onclick='<?php echo esc_js( $cctor_onclick ); ?>' ><?php echo __('Click to Open in Print View','coupon_creator'); ?></a></div><!--end .opencoupon --><?php
