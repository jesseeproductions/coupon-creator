...
/*
* Coupon Creator License Store URL Deprecated
* since 2.4
*/
if ( ! defined( 'COUPON_CREATOR_STORE_URL' ) ) {
	define( 'COUPON_CREATOR_STORE_URL', 'https://couponcreatorplugin.com/edd-sl-api/' );
}
