	...
	/***************************************************************************/
		...
		*/
		public function coupon_option_styles() {
			...
			$coupon_creator_admin = CCTOR_PATH.'admin/css/options.css';
			wp_enqueue_style( 'coupon_creator_admin', CCTOR_URL . 'admin/css/options.css', false, filemtime($coupon_creator_admin));
